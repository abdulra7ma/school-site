...
def test_teacher_school_success():
    ...
    Teacher.objects.create(phone_number="012345878", email="email@test.com", full_name="test user")
...
def test_teacher_query_objects_create_teacher_password_has(test_password):
    ...
    teacher = Teacher.objects.create_teacher(email="email@test.com", password=test_password)
